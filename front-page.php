...
<div class="container">
              ...
              <div class="carousel-inner" role="listbox">
                <?php $i=0; while($slider->have_posts()): $slider->the_post(); ?>
                    <div class="carousel-item <?php echo ($i == 0) ? 'active' : '' ?>">
                          ...
                          <?php the_post_thumbnail( 'products', array('class' => 'd-block img-fluid', 'alt' => get_the_title()) ); ?>
  ...
  <div class="container pb-5">
    <div class="row justify-content-center">
        <?php $args = array(
          'post_type' => 'page' ,
          'post_name__in' => array('about', 'products', 'services'),
          'orderby' => 'name',
          'order' => 'ASC'
         );
        ...
        <div class="col-12 col-md-4 text-center mb-4 mb-md-0 ">
            <div class="imagen-servicio">
                ...
                <div class="row no-gutters justify-content-center">
                    <div class="col-8  col-md-10 servicio-info pt-4">
  ...
  <div class="container">
     <div class="row">
         <div class="col-md-6 col-12 p-4">
               <?php
                  $args = array(
                    'before_title' => '<h2 class="text-center text-uppercase mt-4">Horarios</h2>' ,
                    'after_title' => '</h2>'
                  );

                    the_widget( 'Schedule_Widget', 'title=schedule', $args );
                ?>
...
<section class="productos container py-5">
  ...
  <div class="row py-5">
       ...
       <?php echo do_shortcode('[spasite_products number=4]') ?>
